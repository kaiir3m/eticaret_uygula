...
namespace eticaret_uygula.Controllers
{
    public class slidersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SliderId,SliderName,Healder1,Healder2,Context,SliderImage")] slider
            slider,IFormFile ImageUpload)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SliderId,SliderName,Healder1,Healder2,Context,SliderImage")] slider 
            slider,IFormFile ImageUpload )
        {
            if (ImageUpload != null)
            {
